...
public class VertexColorTextureBaker {
    ...
    public func setup() throws {
        let shadersUrl = try getShaderUrl(name: "vertex_color_baker_shaders")
        ...
        guard
            let vertexFunction = library.makeFunction(
                name: "vertexColorBakerVertexShader"
            )
        else {
        ...
        guard
            let fragmentFunction = library.makeFunction(
                name: "vertexColorBakerFragmentShader"
            )
        else {
    ...
    public func draw(
        ...
        let vertexBuffer = device.makeBuffer(
            bytes: vertices,
            length: MemoryLayout<Argument>.stride * vertices.count,
            options: []
        )
